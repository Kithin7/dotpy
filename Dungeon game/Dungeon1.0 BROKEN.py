...
if Char=="Doug":
    ...
    if PW=="NY4N":
        ...
        print("1, swim, dive, no, no, yes, right, right, nicely greet old man, yes, 42.")
        print("1, swim, swim, yes, right, right, nicely greet old man, yes, 42.")
if Char!="Doug":
        ...
        if A=="sneak":
            ...
            if B=="left":
                ...
                if C=="right":
                    ...
                    Duel=input("The Warrior Bear notices your sword %s, and offers a duel to the death. Do you accept the offer?: " % SW)
                    if Duel=="no":
                        print("FAILURE")
			print("The Warrior bear became raged and killed you.")
		    if Duel=="yes":
			print("You succeed in winning the duel to the death against the Warrior Bear.")
			print("The dieing Bear's last words were, \"%s, when nothing goes right, go left.\"" % Char)
			D=input("While confused at what the Warroir Bear said, you notice the two doors. Do you go through the left or right?: ")
